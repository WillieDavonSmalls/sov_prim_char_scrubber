...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','5','Frame,Joisted Masonry,metal');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','2','IIB   Masonry,MASONARY,MASONARY BEARING WALLS,MASONRY,Masonry Concrete,MASONRY BEARING WALLS,Masonry Concrete,Masonry Concrete Floor Brick Veneer,MC Masonry');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','3B','Granite Precast Concrete,Pre-Cast Concrete,Precast concrete bearing walls,steel pipe columns supporting wood roof framing,Precast concrete Columns, beams,,steel truss joists supporting open web steel floor,steel frame roof,precast concrete framing system,interior steel columns, steel beams,,structural, precast concrete, wall panels,poured concrete slab,Superstructure consists,roof beams topped,roof joists,floor,planks,double-');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','4B1','metal frame');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','37','-Combustible');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','4A1','Steel Moment Frame');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','2B1','Rock  Metal Building,Stone,/ brick exterior');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('FIRE','2','ISO 2,Joist Masonry,Joisted Mas,Joisted Masonry,joisted masonry (1+2 st,joisted masonry  frame,Mixed - 64% JM - 36% Frame');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('FIRE','8','Superior,-Combustible');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','3A4','Concrete Shear Wall');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','1B','Type IV heavy timber frame,reinforced precast concrete (,(2) stories,(6) stories,grade parking,grade),Building');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','2C1','East  West Tower,Load bearing reinforced concrete masonry,pre-case concrete floor,roof framing,Conference Center,structural tilt,pre-cast concrete wall panels,steel columns supporting steel roof framing,interior pilasters');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','3A6','office,Continuous perimeter steel reinforced concrete spread footings,office planer side,rail road 6ft,concrete slab-,-grade');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','2B2','Brick,Brick  Masonry Block,Brick  Metal,Frame,Brick Building,brick façade  metal,brick façade metal,brick, stucco,,roof,brick  steel,Brick Block (ISO 1),Brick Frame,Brick Stucco,Reinforced Concrete & Brick,steel');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','0','Concrete Slab,empty lot,Flame Resistive,flex space,lot,parking structure,Tent');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('FIRE','5','MFR,Modified Fire Resistive,Mofified Fire Resistive');

-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('RMS','18','-Combustible,Mofified Fire Resistive,Frame,Masonry-');
...
-- insert into construction (bldgscheme, bldgclass, bldgdesc) VALUES('FIRE','4','-Combustible,MNC,reinforced  concrete walls,Combustible,masonry noncombustible,Masonry,Masonry NC,-Combustible Fire Resistive,Masonry-,-Combustible (ISO 4),ISO 3,Mas,ISO 4,roofs,wind resistive,Masonry -,combustible,-Comb,Masonary');
